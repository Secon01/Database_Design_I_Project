...
-- === Inside last 30 days ===
(1,  NOW() - INTERVAL 5  DAY,  'new',        NOW() - INTERVAL 4  DAY, 'PAY-ANDERS-001',   '-',           'Luthagsesplanaden 12', 'Uppsala', '75225', 1),
(2,  NOW() - INTERVAL 12 DAY, 'open',       NOW() - INTERVAL 10 DAY, 'PAY-MARIA-002',    'PN-SE-1002',  'Sysslomansgatan 8',    'Uppsala', '75311', 2),
(3,  NOW() - INTERVAL 20 DAY, 'new',        NOW() - INTERVAL 18 DAY, 'PAY-JOHAN-003',    '-',           'Storgatan 1',          'Uppsala', '75331', 3),
(4,  NOW() - INTERVAL 7  DAY, 'dispatched', NOW() - INTERVAL 6  DAY, 'PAY-SOFIA-004',    'PN-SE-1004',  'Flogstavägen 88',      'Uppsala', '75263', 4),
(5,  NOW() - INTERVAL 1  DAY, 'dispatched', NOW() - INTERVAL 1  DAY, 'PAY-ELIN-005',     'PN-SE-1005',  'Rackarbergsgatan 50',  'Uppsala', '75232', 6),
(6,  NOW() - INTERVAL 25 DAY, 'new',        NOW() - INTERVAL 24 DAY, 'PAY-LARS-006',     '-',           'Vaksalagatan 30',      'Uppsala', '75331', 8),
(7,  NOW() - INTERVAL 15 DAY, 'dispatched', NOW() - INTERVAL 12 DAY, 'PAY-EMMA-007',     'PN-SE-1007',  'Sernanders Väg 4',     'Uppsala', '75261', 9),
(8,  NOW() - INTERVAL 3  DAY, 'open',       NOW() - INTERVAL 2  DAY, 'PAY-ANDERS-008',   'PN-SE-1008',  'Luthagsesplanaden 12', 'Uppsala', '75225', 1),

-- === 31–60 days old (outside last 30 days) ===
(9,  NOW() - INTERVAL 40 DAY, 'dispatched', NOW() - INTERVAL 38 DAY, 'PAY-VIKTOR-009',   'PN-SE-1009',  'Götgatan 12',          'Uppsala', '75222', 15),
(10, NOW() - INTERVAL 45 DAY, 'new',        NOW() - INTERVAL 44 DAY, 'PAY-KRISTINA-010', '-',           'Drottninggatan 10',    'Stockholm','11151', 7),
(11, NOW() - INTERVAL 55 DAY, 'dispatched', NOW() - INTERVAL 53 DAY, 'PAY-ALICE-011',    'PN-SE-1011',  'Villavägen 5',         'Uppsala', '75236', 12),
(12, NOW() - INTERVAL 50 DAY, 'open',       NOW() - INTERVAL 49 DAY, 'PAY-MARIA-012',    'PN-SE-1012',  'Sysslomansgatan 8',    'Uppsala', '75311', 2),

-- === 61–90 days old (far outside last 30 days) ===
(13, NOW() - INTERVAL 70 DAY, 'new',        NOW() - INTERVAL 69 DAY, 'PAY-MOHAMMED-013', '-',           'Kantornsvägen 20',     'Uppsala', '75421', 5),
(14, NOW() - INTERVAL 85 DAY, 'new',        NOW() - INTERVAL 84 DAY, 'PAY-OSKAR-014',    '-',           'Döbelnsgatan 2',       'Uppsala', '75237', 10);
